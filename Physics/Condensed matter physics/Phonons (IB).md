...
### Energy of one mode
- If the solid is in _contact_ with a reservoir of temperature $T$, then the _number of phonons $n$ in a mode_ of frequency $\omega$ follows the [[Foundations of statistical thermodynamics#Boltzmann Distribution|Boltzmann Distribution]]:
$$P_n\propto\exp\left(-\frac{n\hbar\omega}{k_BT}\right)\equiv\exp(-n\beta\hbar\omega)$$
- One can then write the [[Foundations of statistical thermodynamics#The Partition Function|Partition Function]]:
...
$$E_i\approx k_BT$$
- This agrees with the [[Foundations of statistical thermodynamics#The classical limit: equipartition|equipartition theorem]], where each vibrational mode has $k_BT$ of energy, _independent of frequency_
